 ...
 * @modified by marianna 20210330 made invoice implements Taxable
 */
public class Invoice implements Taxable {
    ...
    public void getInformation() {
         ...
         * *********************************************************************
         *
         * Ask the user which type of employee they would like to create. First
         * Year, Second Year, or Past Graduate would be the three options.
         * Create the correct type of employee to be assigned to the employee
         * attribute.
         *
         **********************************************************************
         */
    ...
    public double getEarnings() {
         ...
         * *********************************************************************
         *
         * This will require you to use the instanceof operator to determine the
         * type of the object. Using if selection structure, determine the type
         * of employee and apply the correct bonus to the earnings.
         *
    ...
    public double calculateTaxAmount() {
        double tax = 0;
        if (employee instanceof EmployeeFirstYearStudent || employee instanceof EmployeeSecondYearStudent) {
            tax = TAX_PERCENTAGE_STUDENT;
        }
        if (employee instanceof EmployeePastGraduate) {
            tax = TAX_PERCENTAGE_NON_STUDENT;
        }
        return tax * getEarnings();
    }
